...
from tools.engineering_source_plates.aveling_5499_v10.drafting import circle, rect, region, visible_paths
from tools.engineering_source_plates.aveling_5499_v10.engine import wheel, return_pipe_mask
from tools.engineering_source_plates.aveling_5499_v10.verify_plotting import audit
...
centre_errors = [(engine_box[0] + engine_box[2]) / 2 - drawing['x'] - drawing['width'] / 2,
                 (engine_box[1] + engine_box[3]) / 2 - drawing['y'] - drawing['height'] / 2]
...
report = {'schema': 'aveling-5499-detail-verification-v10', 'master_svg_sha256': master_hash,
    ...
    'roller_rim_pen_checks':rim_pen_checks,
