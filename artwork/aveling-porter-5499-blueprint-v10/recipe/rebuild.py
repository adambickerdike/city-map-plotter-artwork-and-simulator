...
def main():
    ...
    names={'revision-9-master.svg','Rolling_186_Autumn_2021.pdf','reference-landmarks.json'}
    ...
    run('tools/engineering_source_plates/build_aveling_5499_final.py','--output-dir',out)
    ...
    run('tools/engineering_source_plates/aveling_5499_v10/verify_drawing.py',out)
