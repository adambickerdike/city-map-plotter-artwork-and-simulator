# Software import — Porsche 911 2.0 Targa technical blueprint v1
...
git lfs pull
sha256sum -c artwork/porsche-911-2-0-targa-technical-blueprint-v1/CHECKSUMS.sha256
...
`simulation/porsche-911-2-0-targa-plotsim.html` directly in a browser.

## Import into another plotting application

Import `artwork/porsche-911-2-0-targa-technical-blueprint.svg` at exactly 420 x
297 mm. Do not scale, fit, centre, outline, hatch, dash, or trace it. Plot the
three top-level physical groups in document order:

1. `layer-pen-white-0-3` — White 0.30 mm — native car geometry;
