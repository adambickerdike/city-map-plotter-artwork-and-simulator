...
# available in at least one ink: 0.25/0.40 in the general colour set, 0.60/1.00
# in black, 0.70/1.00 in white, and 1.00 in gold/silver.  Ink-specific
...
NIB_LADDER = {
    ...
    # inventory additionally enforces that 0.60 is black-only, 0.70 is
    # white-only, and 1.00 is limited to black/white/gold/silver.
    "A5": [0.25, 0.40, 0.60, 0.70, 1.00],
    "A4": [0.25, 0.40, 0.60, 0.70, 1.00],
    "A3": [0.25, 0.40, 0.60, 0.70, 1.00],
}
    ...
    result = {
        ...
        "landmark_buildings": {
            **LANDMARK_BUILDINGS[sheet],
            "nib_mm": MAP_LINEWORK_NIBS[sheet][LANDMARK_BUILDINGS[sheet]["nib_role"]],
            "max_ink_mm2": _round(
