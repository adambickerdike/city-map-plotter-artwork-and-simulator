...
QUADRANT_CONTACT=(1295,681)
QUADRANT_HANDLE=(1310,585)
# The source photograph shows the blade continuing below the sector before
# the rear wheel hides it. Carry the same straight axis into the existing
# chassis; do not expose an invented lower pivot through the opaque frame.
QUADRANT_LOWER_Y=779
QUADRANT_LOWER=(QUADRANT_CONTACT[0]+(QUADRANT_LOWER_Y-QUADRANT_CONTACT[1])
    *(QUADRANT_CONTACT[0]-QUADRANT_HANDLE[0])/(QUADRANT_CONTACT[1]-QUADRANT_HANDLE[1]),QUADRANT_LOWER_Y)
...
PLANES={'rear-frame-and-platform':100,'tender-and-water-box':155,'boiler-and-smokebox':0,
 ...
 'front-casting':0,'driver-controls':100,'quadrant-lower-blade':100,'rear-brake-and-scraper':185}
...
def side_components():
    ...
    out.append(c)
    c=component('quadrant-lower-blade','Source-visible continuation below the notched quadrant, on the handle axis; its lower end enters the existing chassis and is concealed by the wheel and frame.')
    c.solid(capsule(QUADRANT_CONTACT,QUADRANT_LOWER,3.5),'fine','continuous-lower-lever')
    ...
    lever_a,lever_b=QUADRANT_CONTACT,QUADRANT_HANDLE
...
def model():
    ...
    return resolve_scene(components), {
        ...
        'quadrant_lower_blade':{'contact':[sx(QUADRANT_CONTACT[0],100),QUADRANT_CONTACT[1]],
            'handle':[sx(QUADRANT_HANDLE[0],100),QUADRANT_HANDLE[1]],
            'concealed_end':[sx(QUADRANT_LOWER[0],100),QUADRANT_LOWER[1]],
            'half_width_reference_units':3.5,'plane':100,
            'source':'side-photo-2022','hidden_by':['rear-frame-and-platform','tender-and-water-box','rear-inner-spokes','rear-driving-roll'],
            'qualification':'Exposed continuation is source-observed. Internal pivot and linkage are obscured and are not drawn as visible hardware.'},
