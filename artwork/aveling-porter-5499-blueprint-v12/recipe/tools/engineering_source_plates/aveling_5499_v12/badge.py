...
def add_badge(detail,outline,zone,*,horse_enlargement=1.65,plate_enlargement=1.32,gap=6):
    ...
    horse_cx=zone.right-edge_inset-horse_width/2
    cy=zone.centre[1]
    plate=meta['worksplate_ellipse_mm']
    plate_rx=plate['rx']*plate_enlargement
    plate_cx=horse_cx-horse_width/2-gap-plate_rx
    ...
    meta.update(zone={'x':zone.x,'y':zone.y,'width':zone.width,'height':zone.height},
        ...
        horse_width_mm=horse_width,inter_vignette_gap_mm=gap,
        enlargement_from_v11={'horse':horse_enlargement/previous_scale,
                              'worksplate':plate_enlargement/previous_scale},
        transforms_from_v11=previous_transforms,
