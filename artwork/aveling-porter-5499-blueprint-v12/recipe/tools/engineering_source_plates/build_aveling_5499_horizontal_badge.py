...
from tools.engineering_source_plates.aveling_5499_v12.lettering import text
from tools.engineering_source_plates.aveling_5499_v12.engine import model
from tools.engineering_source_plates.aveling_5499_v12.badge import add_badge

DATA=Path(__file__).with_name('aveling_5499_v12')
DEFAULT_OUTPUT=ROOT/'examples/technical-objects/aveling-porter-5499-blueprint-v12'
...
def build(output,dpi):
    ...
    art=PlateArtwork(subject_id=ID,domain='heritage-engine-portrait',subject_kind='steam-road-roller',title='AVELING & PORTER',subtitle='R6 STEAM ROAD ROLLER',
      ...
      rendering_preset='heritage-engine-white-blueprint-v12',format_subject_policy='user-authorised-single-elevation-bottom-strip',
