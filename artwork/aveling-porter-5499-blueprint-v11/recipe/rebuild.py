...
def main():
    ...
    names={'revision-10-master.svg','revision-9-master.svg','Rolling_186_Autumn_2021.pdf','reference-landmarks.json'}
    ...
    run('tools/engineering_source_plates/build_aveling_5499_layout.py','--output-dir',out)
    ...
    run('tools/engineering_source_plates/aveling_5499_v11/verify_drawing.py',out)
