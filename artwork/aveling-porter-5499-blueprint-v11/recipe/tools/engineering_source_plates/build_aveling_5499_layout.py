...
from tools.engineering_source_plates.aveling_5499_v11.lettering import text
from tools.engineering_source_plates.aveling_5499_v11.engine import model
from tools.engineering_source_plates.aveling_5499_v11.badge import add_badge

DATA=Path(__file__).with_name('aveling_5499_v11')
DEFAULT_OUTPUT=ROOT/'examples/technical-objects/aveling-porter-5499-blueprint-v11'
ID='aveling-porter-5499-blueprint'
BLUE='#113b58'
BADGE_ENLARGEMENT=1.10
...
def page_context():
    ...
    badge=Rect(drawing.right-10*gap*BADGE_ENLARGEMENT,drawing.y,10*gap*BADGE_ENLARGEMENT,13*gap*BADGE_ENLARGEMENT)
...
def build(output,dpi):
    ...
    badge_meta=add_badge(smallcopy,outlines,context.zones['heritage_badge'],enlargement=BADGE_ENLARGEMENT)
    ...
    art=PlateArtwork(subject_id=ID,domain='heritage-engine-portrait',subject_kind='steam-road-roller',title='AVELING & PORTER',subtitle='R6 STEAM ROAD ROLLER',
      ...
      rendering_preset='heritage-engine-white-blueprint-v11',format_subject_policy='user-authorised-single-elevation-bottom-strip',
