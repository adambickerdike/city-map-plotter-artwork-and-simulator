...
def side_components():
    ...
    c=component('rear-frame-and-platform','Continuous frame from firebox to water tank; rivets only in observed rows.')
    c.solid(Path(864,710).line(1030,710).line(1150,757).line(1426,757).line(1426,978)
      .line(1357,998).line(812,998).line(812,985).line(842,953).line(854,894).close().vector())
